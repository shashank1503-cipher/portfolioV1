    ...
    <>
      ...
      <div className={styles.mobileNavbar} >
        <div className={styles.openButton}>
          <a href="#" onClick={openNav} style={{display: `${menuOpacity ? 'none' : 'flex'}`}}>
            &#9776;
          </a>
        </div>
        <div className={styles.sideNav} style={{width: `${menuOpacity ? '100%' : '0%'}`}}>
          <div className={styles.closeButton}>
            <a href="#" onClick={closeNav}>
              &times;
            </a>
          </div>
          <ul className={styles.menu} style={{opacity: `${menuOpacity ? '1' : '0'}`}}>
            <li>
